...
final as (
    ...
    select
        ...
        , to_timestamp_ntz(u.created_at_utc)      as registered_at_utc
        , to_timestamp_ntz(u.updated_at_utc)      as last_updated_at_utc
        , to_timestamp_ntz(u.date_load)           as date_load
